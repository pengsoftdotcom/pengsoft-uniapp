        ...
        <view class="w-list-wrap" style="margin-top: 54px">
            ...
            >
                <view class="w-list-item-title ellipsis-2"
                    >{{ item.code }} - {{ item.checker.person.name }}</view
                >
                <view class="w-list-item-body">
                    ...
                    <view v-if="item.status.code === 'risk'">
                        <text v-if="item.handledAt">
                            于
                            <text class="time">{{ item.handledAt }}</text> 整改
                        </text>
                ...
                <view
                    ...
                    :class="item.status.code === 'safe' ? 'success' : 'warning'"
                >
                    {{ item.status.name }}
                </view>
                <view class="w-list-item-angle" v-if="item.handledAt"
                    >已整改</view
                >
            </view>
        </view>
