...
/* 0 */
/*!**************************************************************!*\
  !*** /Users/peng.dang/Work/pengsoft/pengsoft-uniapp/main.js ***!
  \**************************************************************/
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 3));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _createForOfIteratorHelper(o, allowArrayLike) {var it;if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) {if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {if (it) o = it;var i = 0;var F = function F() {};return { s: F, n: function n() {if (i >= o.length) return { done: true };return { done: false, value: o[i++] };}, e: function e(_e) {throw _e;}, f: F };}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion = true,didErr = false,err;return { s: function s() {it = o[Symbol.iterator]();}, n: function n() {var step = it.next();normalCompletion = step.done;return step;}, e: function e(_e2) {didErr = true;err = _e2;}, f: function f() {try {if (!normalCompletion && it.return != null) it.return();} finally {if (didErr) throw err;}} };}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;var URL_PREFIX = 'https://api.pengsoft.com';uni.isAuthenticated = function () {var cache = uni.getStorageSync("pengsoft");var accessToken = cache.accessToken;return accessToken && accessToken.expiredAt && accessToken.expiredAt - new Date().getTime() + 1000 * 60 * 30 > 0;};uni.getAccessToken = function () {var cache = uni.getStorageSync("pengsoft");return cache.accessToken.value;};uni.getUserDetails = function () {var cache = uni.getStorageSync("pengsoft");return cache.userDetails;};uni.hasAnyRole = function (roleCode) {var cache = uni.getStorageSync("pengsoft");return cache.userDetails.roles.some(function (role) {if (Array.isArray(roleCode)) {return roleCode.some(function (code) {return code === role.code;});} else {return role.code === roleCode;}});};uni.hasAuthority = function (authorityCode) {var cache = uni.getStorageSync("pengsoft");return cache.userDetails.authorities.some(function (authority) {if (Array.isArray(authorityCode)) {return authorityCode.some(function (code) {return code === authority;});} else {return authority === authorityCode;}});};uni.addInterceptor('request', { invoke: function invoke(args) {uni.showLoading();args.url = URL_PREFIX + args.url;if (!args.header) {args.header = {};}if (!args.header['Content-Type']) {args.header['Content-Type'] = 'application/x-www-form-urlencoded';};if (uni.isAuthenticated()) {args.header['Authorization'] = 'Bearer ' + uni.getAccessToken();}var success = args.success;args.success = function (res) {if (res.statusCode !== 200) {failure(res);} else {success(res);}};}, fail: function fail(args) {failure(args);}, complete: function complete() {uni.hideLoading();} });var failure = function failure(args) {switch (args.statusCode) {case 422:for (var name in args.data) {var _iterator = _createForOfIteratorHelper(args.data[name]),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var error = _step.value;uni.showToast({ title: error, icon: 'error' });}} catch (err) {_iterator.e(err);} finally {_iterator.f();}}break;default:uni.showModal({ title: '提示', content: args.data.error_description, showCancel: false, confirmColor: '#ff4d4f' });break;}};
...
/* 6 */
/*!**************************************************************!*\
  !*** /Users/peng.dang/Work/pengsoft/pengsoft-uniapp/App.vue ***!
  \**************************************************************/
/*! no static exports found */
...
/* 7 */
/*!***************************************************************************************!*\
  !*** /Users/peng.dang/Work/pengsoft/pengsoft-uniapp/App.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 8 */
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/peng.dang/Work/pengsoft/pengsoft-uniapp/App.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 9 */
/*!***********************************************************************************************!*\
  !*** /Users/peng.dang/Work/pengsoft/pengsoft-uniapp/App.vue?vue&type=style&index=0&lang=css& ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 10 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/peng.dang/Work/pengsoft/pengsoft-uniapp/App.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
