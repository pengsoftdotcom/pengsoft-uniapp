...
export default {
    ...
    methods: {
        ...
        forward() {
            const module = '/module-' + this.formModel.targetPath.split('/')[1];
            uni.navigateTo({
                url: `${module}${this.formModel.targetPath}/edit/edit?id=${this.formModel.targetId}`
            });
        }
    }
};
