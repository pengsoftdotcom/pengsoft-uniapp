    ...
    <view class="center">
        ...
        >
            <uni-list-item
                ...
                :key="i"
                v-if="isMenuVisible(submenu)"
                :title="submenu.title"
                :link="!!submenu.url"
                :to="submenu.url"
                :show-extra-icon="!!submenu.icon"
                :extraIcon="{ type: submenu.icon, color: '#999' }"
                :show-badge="!!submenu.badge"
                :badge-text="submenu.badge"
                :clickable="!!submenu.click"
                @click="submenu.click && submenu.click()"
            >
            </uni-list-item>
        </uni-list>
            ...
            menus: [
                [
                    ...
                    },
                    {
                        title: '工资',
                        icon: 'wallet',
                        url: '/oa/payroll-detail/list/list',
                        badge: 0,
                        roles: ['worker']
                    }
                ]
